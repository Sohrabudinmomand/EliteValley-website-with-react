        ...
        <div className="content-how-it-works-section">
          ...
          <div className="description-box-how-it-works">
            <div className="making-the-two-span-in-one-row">
              ...
              <span className="automatic-tools">How It Works</span>
            </div>
          ...
          <div className="managment-card-content">
            <div className="card-descriptions-box-in-how-it-works">
              ...
              <div className="three-contents-flex">
                <h5 className="title-cards-how-it-works">Payment</h5>
                <p className="paragraph-cards-how-it-works">
