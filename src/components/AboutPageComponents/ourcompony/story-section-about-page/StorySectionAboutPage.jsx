  ...
  const researchData = [
    {
      ...
      researchTitle: "Research and Content Planning 1",
      researchInfo:
    ...
    {
      researchDate: "February 2023 -",
      researchTitle: "Research and Content Planning 2",
      researchInfo:
        "Access advanced order types including limit, market, stop limit and dollar cost averaging. Track your total asset holdings, values and.",
      svgCode: (
        <svg
    ...
    {
      researchDate: "March 2023 -",
      researchTitle: "Research and Content Planning 3",
      researchInfo:
        "Access advanced order types including limit, market, stop limit and dollar cost averaging. Track your total asset holdings, values and.",
      svgCode: (
        <svg
    ...
    {
      researchDate: "April 2023 -",
      researchTitle: "Research and Content Planning 4",
      researchInfo:
        "Access advanced order types including limit, market, stop limit and dollar cost averaging. Track your total asset holdings, values and.",
      svgCode: (
        <svg
        ...
        <div className="image-and-research-parts">
          ...
          <div className="research-parts">
            {researchData.map((item, index) => (
              <div key={index} className="research-content-box">
                <div className="logo-content">{item.svgCode}</div>
                <div className="description-research">
                  <span className="date-of-research">{item.researchDate}</span>
